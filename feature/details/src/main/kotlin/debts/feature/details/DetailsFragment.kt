...
import debts.feature.details.adapter.DebtItemLayout
import debts.feature.details.adapter.DebtsAdapter
import debts.feature.details.mvi.DetailsIntention
import debts.feature.details.mvi.DetailsState
            ...
            if (this.amount != 0.0) {
                intentionSubject.onNext(
                    this.existingDebtId?.let {
                        debts.feature.details.mvi.DetailsIntention.EditDebtSave(
                            it,
                            this.amount,
                            this.comment,
                            this.date
                        )
                    } ?: debts.feature.details.mvi.DetailsIntention.AddDebt(
                        debtorId,
                        this.amount,
                        this.comment,
                        this.date
